...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="Vegetables")
...
class Vendor(models.Model):
    ...
    contact = models.CharField(max_length=100, default="+254(123)(123)(123)")
    char_resp_time = models.CharField(max_length=100, default="100")
...
class CartOrder(models.Model):
    ...
    price = models.DecimalField(max_digits=999999999, decimal_places=2, default="1.99")
    paid_status = models.DecimalField(default=False, decimal_places=2, max_digits=99999999)
